...
class LocalWorkflowInterceptor extends Interceptor {
  ...
  static const _cardTypes = [
    {'id': 'farmer', 'code': 'farmer', 'name': 'Farmer Card', 'eligibility_criteria': 'Submit your documents for administrative review.', 'required_documents': ['nid_copy', 'union_paurosova_certificate', 'recent_photo', 'agricultural_certificate'], 'application_fields': []},
    {'id': 'family', 'code': 'family', 'name': 'Family Card', 'eligibility_criteria': 'Submit your documents for administrative review.', 'required_documents': ['nid_copy', 'union_paurosova_certificate', 'recent_photo', 'income_certificate'], 'application_fields': []},
    {'id': 'education', 'code': 'education', 'name': 'Education Card', 'eligibility_criteria': 'Submit your documents for administrative review.', 'required_documents': ['nid_birth_certificate', 'ssc_registration_card', 'ssc_admit_card', 'ssc_certificate', 'hsc_registration_card', 'hsc_admit_card', 'hsc_certificate', 'recent_photo'], 'application_fields': []},
    {'id': 'worker', 'code': 'worker', 'name': 'Worker Card', 'eligibility_criteria': 'Submit your documents for administrative review.', 'required_documents': ['nid_copy', 'worker_certificate', 'labor_registration', 'income_certificate'], 'application_fields': []},
  ];
